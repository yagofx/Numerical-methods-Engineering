proc SimpleCFD::WriteParametersFile {fname} {
    ...
    foreach group [SimpleCFD::GetSkinModelpartsGroups] {
        ...
        # Setting 3D or 2D wall condition
        set condition_type [SimpleCFD::GetElementTypeUsedByGroup $group]
        if { $condition_type == "Linear"} {
            set condition_name "WallCondition2D2N"
        }
        if { $condition_type == "Triangle"} {
            set condition_name "WallCondition3D3N"
        }
